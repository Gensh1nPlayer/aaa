(() => {
  const copy = {
    ...
    ar: {
      ...
      beforeOrdering:'قبل الطلب', currencyNoticeOne:'يدعم خيار الإضافة المباشرة حسابات Battle.net في جميع المناطق وفق الأهلية.', currencyNoticeTwo:'أنفق Coins أو Prisms المضافة فور تسجيل الدخول؛ فهي غير مخصصة للحفظ لاحقاً.', currencyNoticeThree:'خلال 1–24 ساعة قد يصبح الرصيد المتبقي سالباً، بينما يُتوقع بقاء العناصر المشتراة.', currencyNoticeFour:'يجب تأكيد التوفر وطريقة التسليم والمدة وملاءمة الحساب عبر Discord قبل الدفع.',
    ...
    ja: {
      ...
      beforeOrdering:'注文前の確認', currencyNoticeOne:'直接付与は、対象条件を満たす全地域のBattle.netアカウントに対応します。', currencyNoticeTwo:'付与されたCoinsまたはPrismsはログイン後すぐに使用し、後日のために保存しないでください。', currencyNoticeThree:'1～24時間後に残高がマイナスになる場合がありますが、購入済みアイテムは残る想定です。', currencyNoticeFour:'在庫、引き渡し方法、所要時間、アカウントの対象可否は支払い前にDiscordで確認してください。',
